...
def main():
    ...
    tracks = tracker.get_object_tracks(video_frames,read_from_stub=True,stub_path='stubs/tracker_stub.pkl')
    ...
    speed_and_distance_estimator.draw_speed_and_distance(output_video,tracks)
